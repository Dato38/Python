...
#5) Создаем функцию, которая сохранит наши зарегистрированные данные
    def save():#41
        ...
        f=open("login.txt", "wb")#44 Создадим документ, в котором это будет храниться
...
#6) Создаем функцию проверки правильности введенного пароля
    def log_pass(): #50
        f=open("login.txt", "rb")#51 Мы должны открыть тот файл, в котором сохранились наши данные
